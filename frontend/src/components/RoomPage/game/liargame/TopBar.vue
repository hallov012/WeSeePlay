...
const liarGameManual = () => {
  Swal.fire({
    ...
    if (result.isConfirmed === true) {
      ...
      Swal.fire({
        title: "당신은 라이어입니다",
        html: "다른 사람들이 말하는 설명을 듣고, 제시어가 무엇인지 추측해 보세요.<br>당신 차례가 오면 사람들이 당신이 라이어란 사실을 눈치채지 못하게<br>숨겨진 제시어에 대해 그럴듯하게 설명한 후 버튼으로 턴을 넘기세요.<br>최종 투표를 무사히 넘긴다면 당신의 승리입니다!",
        showCancelButton: true,
